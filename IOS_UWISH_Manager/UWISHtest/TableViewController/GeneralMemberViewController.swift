//
//  GeneralMemberViewController.swift
//  UWISHtest
//
...
class GeneralMemberViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cellId = "GeneralMemberCell"
        let cell = tableView.dequeueReusableCell(withIdentifier: cellId) as! GeneralMemberTableViewCell
